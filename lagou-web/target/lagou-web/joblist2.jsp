...
-->
        ...
        <div class="content">
            <div id="search_box">
                <form id="searchForm2" name="searchForm" action="job/ajaxquery" method="post">
                    <ul id="searchType">
                        <li data-searchtype="1" class="type_selected">职位</li>
                        <li data-searchtype="4">公司</li>
                    </ul>
                    <div class="searchtype_arrow"></div>
                    <input type="text" id="search_input" name = "jobName"  tabindex="1" value="前端开发"  placeholder="请输入职位名称，如：产品经理"  />
			...
			<form id="queryform" action="job/ajaxquery" method="post">
...
<script>
    $(function(){
	    	...
	    	$("#queryform").ajaxSubmit(function(result){
	            ...
	            $.each(result.list,function(index,job){
	                 str +="<li class=\"odd clearfix\">\n" +
	                     ...
	                     "                        <br />\n" +
	                     "                        <span><em class=\"c7\">职位类型：</em>"+job.threeType.threetypeName+"</span>\n" +
	                     "                    </div>\n" +
	                     "                    <div class=\"hot_pos_r\">\n" +
	                     "                        <div class=\"apply\">\n" +
	                     "                            <a href=\"toudi.html\" target=\"_blank\">投个简历</a>\n" +
        ...
        $("#search_button").click(function(){
        	...
        	$("input[name=jobName]").val(val);//设置到queryform表单中kd中
        	$("#pageNum").val(1);
        	ajaxSubmit();//调用ajaxForm表单方法
        	return false;
        });
